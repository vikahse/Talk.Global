...
3. Затем пользователь автоматически оказывается на странице, на которой он может увидеть ту самую карточку, которую добавил.
4. При заполнении всех полосок VELCRO пользователь сможет добавлять и другие карточки на эту страницу, но для просмотра их ему будет необходимо скролить влево эту часть экрана.
5. Запускается Сценарий 3 - Создание карточки PECS
нажав на карточку три опции //  править 
